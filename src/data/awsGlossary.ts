...
const rows = [
  ...
  },
  {
    ...
    "chinese": "AWS 账户根用户",
    "japanese": "AWS アカウントのルートユーザー",
    "note": "只用于必须由根用户完成的少数账户任务。",
    "frequency": 5
  },
  {
    "term": "Route 53",
  ...
  },
  {
    ...
    "chinese": "AWS 软件开发工具包",
    "japanese": "AWS SDK（AWS ソフトウェア開発キット）",
  ...
  },
  {
    ...
    "chinese": "IAM 用户组",
    "japanese": "IAM ユーザーグループ",
    "note": "把策略批量分配给多个 IAM User。",
    "frequency": 3
  },
  {
