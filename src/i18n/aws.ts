const awsUi = {
  zh: {
    ...
    heroSource: '* 内容整理自我自己的 Notion 学习数据库，仅同步已有知识点。',
  ...
  en: {
    ...
    heroSource: '* Curated from my own Notion study database; only existing notes are synchronized.',
  ...
  ja: {
    ...
    heroSource: '* 自分の Notion 学習データベースから整理し、既存の知識だけを同期しています。',
...
const topicCopy: Record<string, Record<string, string>> = {
  en: {
    ...
    'Amazon Kinesis Data Streams & Data Firehose': 'Amazon Kinesis Data Streams & Data Firehose',
    '数据分析核心概念': 'Data Analytics Core Concepts',
    'AI / ML 核心概念': 'AI / ML Core Concepts',
    'AWS AI/ML 三层技术栈': 'AWS AI/ML Three-Layer Stack',
    'Amazon Q Business & Developer': 'Amazon Q Business & Developer',
    '数据分析与机器学习管道': 'Data Analytics & ML Pipeline',
    'Kinesis Data Streams vs Amazon Data Firehose': 'Kinesis Data Streams vs Amazon Data Firehose',
    'Amazon Athena vs Amazon Redshift': 'Amazon Athena vs Amazon Redshift',
    'AWS AI Services vs SageMaker vs ML Infrastructure': 'AWS AI Services vs SageMaker vs ML Infrastructure',
    'SageMaker JumpStart vs Bedrock vs Amazon Q': 'SageMaker JumpStart vs Bedrock vs Amazon Q',
  ...
  ja: {
    ...
    'Amazon Kinesis Data Streams & Data Firehose': 'Amazon Kinesis Data Streams と Data Firehose',
    '数据分析核心概念': 'データ分析の基本概念',
    'AI / ML 核心概念': 'AI / ML の基本概念',
    'AWS AI/ML 三层技术栈': 'AWS AI/ML の3層スタック',
    'Amazon Q Business & Developer': 'Amazon Q Business と Developer',
    '数据分析与机器学习管道': 'データ分析・機械学習パイプライン',
    'Kinesis Data Streams vs Amazon Data Firehose': 'Kinesis Data Streams と Amazon Data Firehose',
    'Amazon Athena vs Amazon Redshift': 'Amazon Athena と Amazon Redshift',
    'AWS AI Services vs SageMaker vs ML Infrastructure': 'AWS AI Services・SageMaker・ML インフラストラクチャ',
    'SageMaker JumpStart vs Bedrock vs Amazon Q': 'SageMaker JumpStart・Bedrock・Amazon Q',
